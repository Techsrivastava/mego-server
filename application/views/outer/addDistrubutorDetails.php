    ...
    <section class="content">
      <form enctype="multipart/form-data" action="<?php echo base_url() . 'organization/updateDistributordetail'; ?>" method="post">
                   ...
                   <div class="input-group">
                    <div class="input-group-btn">
                      <button type="button" class="btn btn-default"  ><i class="fa fa-adjust" aria-hidden="true"></i></button>
                       ...
                       <select class="form-control" id="emp_title" name="emp_title[]" required="required">
                ...
                <div class="form-group">
                  <label>NAME<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $empdata->PR_NAME; ?>" placeholder="Enter Name" id="emp_name" name="emp_name[]" required="required"> 
