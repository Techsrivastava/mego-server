 <?php
    ...
    <section class="content-header">
      <h1>
        ADD ADDRESS | DOCUMENTS | BANK DETAIL
    ...
    <section class="content">
      ...
      <form enctype="multipart/form-data" action="<?php echo base_url() . 'outer/addemployeeaddress'; ?>" method="post">
      <input type="hidden" class="form-control" value="<?php echo $emp_id; ?>"  id="emp_employeeid" name="emp_employeeid" > 
      <input type="hidden" class="form-control" value="3"  id="emp_frmLevel" name="emp_frmLevel"> 
          ...
          <div class="col-md-6" id="permanentaddr">
                        ...
                        <div class="form-group">
                          <br>
                             ...
                             <button type="submit" class="btn btn-info pull-right"  >Next</button>
                              <a href="<?php echo base_url().'outer/addEmployee/'.$this->uri->segment(3).'/1?token='.$this->session->userdata['sampark_session']['token']; ?>"><button type="button" class="btn btn-warning pull-left" style="margin-right:24px">Previous</button></a>
                        </div>
                        </div>        
