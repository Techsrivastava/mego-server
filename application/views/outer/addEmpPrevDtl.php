   <?php
    ...
    <section class="content-header">
      ...
      <h4 style="margin:unset; padding:unset;">
    ...
    <div class="col-md-12" >
      <form enctype="multipart/form-data" action="<?php echo base_url() . 'outer/addemployeeprevdetail'; ?>" method="post">
              ...
              <button  type="button" class="form-control btn-sm btn-success add_field_button"><i class="fa fa-plus"></i></button>
                  ...
                  <br>
                   <button type="submit" class="btn btn-info pull-right" style="margin-right:12px">Submit</button>
                    <a href="<?php echo base_url().'outer/addEmpAddress/'.$this->uri->segment(3).'/2?token='.$this->session->userdata['sampark_session']['token']; ?>"><button type="button" class="btn btn-warning pull-right" style="margin-right:24px" >Previous</button></a>
