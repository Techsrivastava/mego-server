    ...
    <section class="content">
		<form enctype="multipart/form-data" action="<?php echo base_url() . 'organization/updatedistributorexpdtl'; ?>" method="post">
                ...
                <div class="form-group">
                  <label>COMPANY NAME<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $empdata->PR_COMPANY_NAME; ?>" placeholder="Enter Company Name" id="emp_name" name="emp_name[]" required="required"> 
