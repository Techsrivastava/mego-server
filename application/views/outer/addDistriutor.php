    ...
    <form enctype="multipart/form-data" action="<?php echo base_url() . 'organization/updatedistributordtl'; ?>" method="post">
                ...
                <div class="form-group">
                  <label>EMAIL<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <input type="email" class="form-control" value="<?php echo $empdata->PR_EMAIL; ?>" readonly="readonly" placeholder="Enter  Email" id="emp_email" name="emp_email" required="required">    </div>
                </div>
                </div>
                ...
                <div class="form-group">
                  <label>MOBILE 1<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $empdata->PR_PHONE; ?>" placeholder="Enter Mobile No" id="emp_mobile1" name="emp_mobile1" required="required" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="10" min="0" max="99">  </div>
                </div>
                </div>
                <div class="col-md-6">
                <div class="form-group">
                  <label>MOBILE 2</label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $empdata->PR_PHONE2; ?>" placeholder="Enter Mobile 2 No" id="emp_mobile2" name="emp_mobile2" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="10" min="0" max="99">    </div>
                </div>
                </div>
                ...
                <div class="form-group">
                  <label>LAND LINE NO</label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $empdata->PR_LAND_LINE_NO; ?>" placeholder="Enter Land Line No" id="emp_landline" name="emp_landline" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" >    </div>
                </div>
                </div>
                 <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                  <label>COUNTRY<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <select class="form-control" onchange="getstate($(this).val(),'emp_presentstatess')"  id="emp_presentcountry" name="emp_presentcountry">
                ...
                <div class="form-group">
                  <label>STATE<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <select class="form-control" id="emp_presentstatess" name="emp_presentstate" onchange="getcity($(this).val(),'emp_presentcity')">
                ...
                <div class="form-group">
                  <label>PINCODE<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="<?php echo $empdata->PR_PRESENT_PINCODE; ?>" placeholder="Enter Pincode" id="emp_presentpincode" name="emp_presentpincode" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" maxlength="6" min="0" max="99">   
                        ...
                        <div class="form-group">
                          <label>GSTIN FILE<sup style="color: red;">*</sup></label>
                           <div class="input-group">
                            ...
                            <input type="file" class="form-control" value="" placeholder="Enter GSTIN No" id="emp_gstinfile" name="emp_gstinfile">  
                            <?php
                        ...
                        <div class="form-group">
                          <label>PANCARD FILE</label>
                           <div class="input-group">
                            ...
                            <input type="file" class="form-control" value="" placeholder="Enter Aadhar Card No" id="emp_pancardfile" name="emp_pancardfile"> 
                            <?php
                        ...
                        <div class="form-group">
                          <label>CANCELLED CHECK</label>
                           ...
                           <div class="input-group">
                            ...
                            <input type="file" class="form-control" value="" placeholder="Enter Aadhar Card No" id="emp_bankfile" name="emp_bankfile">  
                             <?php
                            if($empdata->PR_PANCARD_FILE)
                            {
                            ?>  
