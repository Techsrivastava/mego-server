    ...
    padding: 0px 4px;
      ...
      <!-- Modal Header -->
            <div class="box-body">
                   ...
                   <div class="input-group">
                    ...
                    <select class="form-control" id="prd_category" name="prd_category">
                      ...
                      <?php foreach ($catproductList as $cprow){ ?>
                        <option <?php if($cprow->PR_PRD_CAT_ID==$prdData->PR_PRD_CAT_ID){ echo 'selected="selected"'; } ?>  value="<?= $cprow->PR_PRD_CAT_ID ?>">
                ...
                <input type="text" class="form-control" value="<?php echo $prdData->PR_PRODUCT_NAME; ?>" placeholder="Enter Product Name" id="product_name" name="product_name">
                </div>
                </div>
                </div>
                <!-- <div class="col-md-3">
                ...
                <div class="input-group">
                <span class="input-group-addon">₹</span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_MRP; ?>" placeholder="Enter MRP Price" id="mrp_price" name="mrp_price">
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="input-group">
                <span class="input-group-addon">₹</span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_SP_PRICE; ?>" placeholder="Enter Retailer Price" id="retailer_price" name="retailer_price">
                </div>
                </div>
                </div>
                ...
                <div class="input-group">
                <span class="input-group-addon">₹</span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_PRICE; ?>" placeholder="Enter Distributor Price" id="distributor_price" name="distributor_price">
                </div>
                </div>
                </div>
                 <div class="col-md-3">
                ...
                <div class="input-group">
                <span class="input-group-addon">%</span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_DISCOUNT; ?>" placeholder="Enter Discount" id="discount" name="discount">
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="input-group">
                <span class="input-group-addon"></span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_NO_OF_PIECE_PER_CARTON; ?>"  placeholder="Enter No Of Piece Per Carton" id="no_of_piece" name="no_of_piece">
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <input type="text" class="form-control" value="<?php echo $prdData->PR_MIN_QTY_PER_ORDER; ?>" placeholder="Enter Min Carton Per Order" id="min_carton_order" name="min_carton_order">
                </div>
                </div>
                </div>
                 <div class="col-md-3">
                ...
                <select class="form-control" style="width: 100%;" data-select2-id="1" tabindex="1" id="storage" name="storage" aria-hidden="true"  required="required">
                        ...
                        {
                        ?>
                        <option <?php if($prdData->PR_PRODUCT_PACK_TYPE==$attrrow->ATTRIBUTE_ID){ echo 'selected="selected"'; } ?> value="<?php echo $attrrow->ATTRIBUTE_ID; ?>"><?php echo $attrrow->ATTRIBUTE_NAME.' ('.$attrrow->ATTRIBUTE_DESC.')';  ?></option>
                        <?php
                        }
                ...
                <select class="form-control" style="width: 100%;" data-select2-id="1" tabindex="1" id="volume_type" name="volume_type" aria-hidden="true"  required="required">
                        ...
                        <option <?php if('KG'==$prdData->PR_PRODUCT_PACK){ echo 'selected="selected"'; } ?>  value="KG">KG</option>
                        <option <?php if('GM'==$prdData->PR_PRODUCT_PACK){ echo 'selected="selected"'; } ?>  value="GM">GM</option>
                        <option <?php if('LITRE'==$prdData->PR_PRODUCT_PACK){ echo 'selected="selected"'; } ?>  value="LITRE">LITRE</option>
                        <option <?php if('ML'==$prdData->PR_PRODUCT_PACK){ echo 'selected="selected"'; } ?>  value="ML">ML</option>
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-align-center" aria-hidden="true"></i></span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_PRODUCT_VOLUME; ?>" placeholder="Enter Package Volume" id="volume" name="volume">
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <input type="text" class="form-control" value="<?php echo $prdData->PR_HEIGHT; ?>" placeholder="Enter Height" id="product_height" name="product_height">
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="input-group">
                <span class="input-group-addon"></span>
                <input type="text" class="form-control" value="<?php echo $prdData->PR_LENGTH; ?>" placeholder="Enter Length" id="product_length" name="product_length">
                </div>
                </div>
                </div>
                <div class="col-md-3">
                ...
                <input type="text" class="form-control" value="<?php echo $prdData->PR_WEIGHT; ?>" placeholder="Enter Weight" id="product_weight" name="product_weight">
                </div>
                </div>
                </div>
