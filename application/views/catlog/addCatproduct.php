    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" ><a href="#" >Add Product Category</a></li>
      </ol>
    </section><br>
    <!-- Main content -->
    <section class="content">
		
      <form enctype="multipart/form-data" action="<?php echo base_url() . 'catlog/addCatProduct'; ?>" method="post">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">          
      ...
      <!-- Modal Header -->
            <div class="box-body">
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" id="product_category" onchange="getsubCategory($(this).val(),'product_subcategory')" name="product_category">
                      ...
                      <?php foreach ($categoryModalList as $prdcat) { ?>
                      	<option value="<?php echo $prdcat->CATEGORY_ID; ?>"><?php echo $prdcat->CATEGORY_NAME; ?></option>
                      <?php } ?> 
                    </select>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="product_name" value="" name="product_name" required="required" placeholder="Enter Product Category Name">
                </div>
                </div>
