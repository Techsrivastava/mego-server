    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li ><a href="<?php echo base_url('organization/employee')."?token=".$this->session->userdata['sampark_session']['token']; ?>">EMPLOYEES MANAGEMENT</a></li>
        <li class="active" >APPLIED EMPLOYEE LIST</li>
        
        <li class="active" ><a href="#"  data-toggle="modal" data-target="#appliedempmodal"><button type="button" class="btn btn-info btn-sm"><i class="fa fa-plus"></i>ADD APPLIED EMPLOYEE</button></a></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                ?>
                 <tr>
                  ...
                  <td><?php if($urow->PR_EMPLOYEE_STATUS=='2'){ echo '<span class="btn btn-warning btn-xs">Invitation Sent</span>'; } else{ echo '<span class="btn btn-success btn-xs">Data Uploaded</span>';} ?></td>
                  <td>
                    <?php
