   <?php //print_r($empdata); exit; ?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li ><a href="<?php echo base_url('Organization/fosList')."?token=".$this->session->userdata['sampark_session']['token']; ?>">Fos List</a></li>
        <li class="active" ><a href="#" >Add Fos</a></li>
      </ol>
    </section><br>
    <!-- Main content -->
    ...
    <input type="hidden" class="form-control" value="1"  id="emp_frmLevel" name="emp_frmLevel"> 
          <div class="box">          
            ...
            <div class="box-body">		
                 ...
                 <input type="hidden" class="form-control" value="12"  id="emp_desigdata" name="emp_desigdata"> 

                 <input type="hidden" class="form-control" value="<?php echo $this->session->userdata['sampark_session']['USER_ID']; ?>"  id="emp_reportmanager" name="emp_reportmanager"> 


                <div class="col-md-3">
                <div class="form-group">
                  <label>SALARY<sup style="color: red;">*</sup></label>
                   <div class="input-group">
                    <div class="input-group-btn">
                      <button type="button" class="btn btn-default"  ><i class="fa fa-inr" aria-hidden="true"></i></button>
                    </div>
                    <input type="number" class="form-control" value="<?php echo $empdata->PR_CTC; ?>" placeholder="Enter Salary" id="emp_ctc" name="emp_ctc" required="required"> 
