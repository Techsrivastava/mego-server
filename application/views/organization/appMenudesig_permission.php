    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" >App Designation Permission</li>
      </ol>
    </section>

    <!-- Main content -->
    <form   enctype="multipart/form-data" action="<?php echo base_url() . 'organization/approleupdatePermission' ?>" method="post">
              ...
              <table id="example1111" class="table table-bordered table-striped">
                ...
                foreach ($appmenu as $row) {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                        $chkMenu1 = $this->Organization_model->chkRoleMenu(array('ROLE_ID' =>$desig,'MENU_ID' =>$row->MENU_ID));
                                    ...
                                    foreach ($submenu1 as $subrow1) {
                                        ...
                                        <tr>
                                            ...
                                            $chkMenu = $this->Organization_model->chkRoleMenu(array('ROLE_ID' =>$desig,'MENU_ID' =>$subrow1->MENU_ID));
                                            // print_r($chkMenu); exit;
                                            if($chkMenu)
                                            {
                                            ?>
