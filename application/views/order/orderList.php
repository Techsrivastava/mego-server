...
?>
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li ><a href="<?php echo base_url('order/order_list')."?token=".$this->session->userdata['sampark_session']['token']; ?>">ORDER LIST </a></li>
        
        <li class="active" ><a href="<?php echo base_url('order/order_form')."?token=".$this->session->userdata['sampark_session']['token']; ?>" ><button type="button" class="btn btn-info btn-sm"><i class="fa fa-plus"></i> ADD ORDER</button></a></li>
      </ol>
    </section>
    <!-- Main content -->
    <?php    
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped ">
                ...
                <tr>
                  <td><?php echo $i; ?></td>
                  <td>ORD-<?php echo $prow->DISTRIBUTOR_ORDER_ID; ?></td>
                 ...
                 <td>Rs. <?php echo $prow->TOTAL-$prow->AMOUNT; ?></td>
                  ...
                  <td>
                       ...
                       <a href="#" title="Upload Payment Proof" data-toggle="modal" data-target="#paymentDOneFOrm"  onclick="getOrderPaymentData('<?php echo $prow->DISTRIBUTOR_ORDER_ID; ?>');"  class="btn btn-primary btn-xs"><i class="fa fa-upload" aria-hidden="true"></i></a>
                        ...
                        <a target="_blank" href="<?php echo base_url('order/distributorOrderInvoice/'); ?><?php echo $prow->DISTRIBUTOR_ORDER_ID; ?>" title="Invoice"  class="btn btn-primary btn-xs"><i class="fa fa-file-o" aria-hidden="true"></i></a>
