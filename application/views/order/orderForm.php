    ...
    <section class="content">
       <form enctype="multipart/form-data" action="<?php echo base_url() . 'order/addOrderForm'; ?>" method="post">
            ...
            <div class="box-body">
              <table id="example1333" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th style="width:12%">QUANTITY<sup style="color:red;"><br>( * In Carton )</sup></th>
                  <th style="width:10%">NO OF PIECES<sup style="color:red;"><br>( * In One Carton )</sup></th>
                  <th style="width:12%">PRICE<sup style="color:red;"><br>( * Single Carton Price)</sup></th>
                ...
                <tr>
                   <td></td>
                   <td> <select class="form-control" id="prd_category" name="prd_category[]" onchange="getCatProduct($(this).val(),'product_packs')" >
                   ...
                   <td><select class="form-control" id="product_packs" name="product_packs[]">
                      <option>Select </option>
                    
                    </select>
                  </td>
                   <td>
                     <input type="text" class="form-control" value=""  id="product_qty" name="product_qty[]" onkeyup="getPrductQtyCount(this.value,'no_of_piecesCOunt','pprice','subprice','');" placeholder="Enter Qty" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" >    

                   </td>

                   <td><input type="text" class="form-control" value="" placeholder="In Carton" id="no_of_piecesCOunt" name="no_of_piecesCOunt[]" readonly="readonly">    </td>
                   <td>
                     <input type="text" class="form-control" value="" placeholder="Carton Price" id="pprice" name="pprice[]" readonly="readonly">    
  ...
  $(add_button).click(function(e){ //on add input button click
    ...
    if(x < max_fields){ //max input box allowed
      ...
      $(wrapper).append('<tr><td></td><td> <select class="form-control" id="prd_category'+x+'" name="prd_category[]" onchange="getCatProduct($(this).val(),'+t+');" ><option>Select </option><?php foreach ($catproductList as $cprow){ ?>
                    ...
                    </select></td><td><select class="form-control" id="product_packs'+x+'" name="product_packs[]"><option>Select </option></select></td> <td> <input type="text" class="form-control" value=""  id="product_qty'+x+'" name="product_qty[]" onkeyup="getPrductQtyCount(this.value,'+cou+','+ppricee+','+subp+','+x+');" placeholder="Enter Qty" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" >   </td><td><input type="text" class="form-control" value="" placeholder="In Carton" id="no_of_piecesCOunt'+x+'" name="no_of_piecesCOunt[]" readonly="readonly">    </td><td><input type="text" class="form-control" value="" placeholder="Carton Price" id="pprice'+x+'" name="pprice[]" readonly="readonly">   </td><td><input type="text" class="form-control" value="" placeholder="" id="subprice'+x+'" name="subprice[]" readonly="readonly"></td></tr>'); 
