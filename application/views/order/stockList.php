    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('order/order')."?token=".$this->session->userdata['sampark_session']['token']; ?>"><i class="fa fa-dashboard"></i>ORDER MANAGEMENT</a></li>
        <li class="active" ><a href="<?php echo base_url('order/stock_list')."?token=".$this->session->userdata['sampark_session']['token']; ?>">STOCK LIST </a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped ">
                ...
                <tr style="font-size:12px !important;">
                  ...
                  <th>PRODUCT NAME</th>
                  <th>AMOUNT</th>
                  <th>QUANTITY<sup style="color: red;"> ( * In Carton)</sup></th>
                  <th>QUANTITY<sup style="color: red;"> (* Pieces In One Carton )</sup></th>
                  <th>STATUS</th>
                  <th>ACTION</th>
                ...
                <tr>
                  ...
                  <td>Rs. <?php echo $prow->PRICE; ?></td>
                  <td><?php echo $prow->QUANTITY; ?></td>
                  <td><?php echo $prow->PR_NO_OF_PIECE_PER_CARTON*$prow->QUANTITY; ?></td>
