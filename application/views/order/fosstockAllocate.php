    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active" ><a href="#" >FOS STOCK ALLOCATION</a></li>
      </ol>
    </section><br>
    <!-- Main content -->
    <?php    
    ...
    <section class="content">
      ...
      <form enctype="multipart/form-data" action="<?php echo base_url() . 'order/addFosProduct'; ?>" method="post">


      <input type="hidden" class="form-control" id="fos_id"  name="fos_id"  value="<?php echo $_REQUEST['empid']; ?>">
      <div class="row">
        <div class="col-xs-12">
          <div class="box">          
            <div class="box box-warning">
            <div class="box-header with-border">
              <h3 class="box-title">FOS STOCK ALLOCATION</h3>
            </div>
            <!-- /.box-header -->
<style>
img.pr_image {
                       ...
                       <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <!-- /btn-group -->
                            <input type="text" class="form-control" id="product_qty" value="" name="product_qty[]"  placeholder="Enter Quantity" onkeyup="getPrdQtyCount(this.value,'no_of_piecesCOunt');" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" >
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <!-- /btn-group -->
                            <input type="text" class="form-control" id="no_of_piecesCOunt" value="" name="no_of_piecesCOunt[]"  >
                           <div class="input-group-btn">
