    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url('order/retailer')."?token=".$this->session->userdata['sampark_session']['token']; ?>"><i class="fa fa-dashboard"></i>RETAILER MANAGEMENT</a></li>
           ...
           <div class="col-xs-6">
            <p>Billed party details :-</p>
             <table class="table">
              <tr>
                ...
                <td style="border-top: unset;border-bottom: 1px solid #d4d4d4;">SAMPARK|20-21|INV-<?php echo $orderData->RETAILER_ORDER_ID; ?></td>
              </tr>
              <tr>
            ...
            <div class="col-xs-6">
             ...
             <tr>
               ...
               <tr>
                <td  style="border: unset;width: 23%"><strong>ADDRESS:-<strong></td>
...
Ghaziabad (UP) - 201010   
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              $orderPrdData = $this->Order_model->getRetailerOrderProducts($orderData->RETAILER_ORDER_ID);
               $i=1;
        $subtotl="";
        $qty="";
      ...
      <div class="row">
        <div class="col-xs-12"><!-- coolumn -->
          <p>Terms & conditions as per Retailer agreement</p>
        ...
        <div class="col-xs-12">
         <!--  <a href="invoice-print.html" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a> -->
          ...
          <button type="button" class="btn btn-primary pull-right" onclick="window.print('tes')" style="margin-right: 5px;">
